/**
 * Meilin's Apothecary - DM Tools
 * Knives, Relationships, Mindersand, and Medica
 */
(function(App) {
     ...
     */
    App.loadDMToolsContent = async function() {
        await Promise.all([
     ...
     */
    App.openKnifeModal = function(knife) {
     ...
     */
    App.loadRelationships = async function() {
     ...
     */
    App.renderRelationships = function() {
        const container = document.getElementById('relationships-map');
     ...
     */
    App.renderRelationshipCard = function(connection) {
     ...
     */
    App.bindRelationshipCardEvents = function() {
        const container = document.getElementById('relationships-map');
        if (!container) return;
     ...
     */
    App.openRelationshipModal = function(connection) {
     ...
     */
    App.closeRelationshipModal = function() {
        const overlay = document.getElementById('npc-modal-overlay');
        if (overlay) {
            overlay.classList.remove('active');
        }
     ...
     */
    App.loadMindersand = async function() {
     ...
     */
    App.renderMedicaRankDetails = function(rank) {
        return `
     ...
     */
    App.bindMedicaRankEvents = function() {
        const container = document.getElementById('medica-content');
        if (!container) return;
